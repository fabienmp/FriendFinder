...
module.exports = function (app, models) {
    ...
    app.post("/api/friend", function (req, res) {
        ...
        friendsContext.create({
            ...
            .then((newFriend) => {
                ...
                var matchingFriend = findMatchingFriend(newFriend);
                console.log(matchingFriend);
                res.status(201).send(matchingFriend);
            })
            .catch((err) => {
    ...
    var findMatchingFriend = function (newFriend) {
